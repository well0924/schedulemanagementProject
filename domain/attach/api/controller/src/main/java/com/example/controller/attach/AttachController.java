...
public class AttachController {
    ...
    private final AttachInterfaces attachInterfaces;

    @GetMapping("/")
    public ResponseEntity<List<AttachResponse>> findAll() {
        List<AttachResponse> attachResponseList = attachInterfaces.findAll();
    ...
    public ResponseEntity<AttachResponse> findById(@PathVariable("id") Long attachId) {
        return ResponseEntity.status(HttpStatus.OK).body(attachInterfaces.findById(attachId));
    }

    @PostMapping("/presigned-urls")
    public ResponseEntity<List<String>> generatePreSignedUrls(@RequestBody List<String> fileNames) {
        List<String> urls = attachInterfaces.generatePreSignedUrls(fileNames);
    ...
    public ResponseEntity<List<AttachResponse>> completeUpload(@RequestBody List<String> uploadedFileNames) throws IOException {
        List<AttachResponse> files = attachInterfaces.createdAttach(uploadedFileNames);
    ...
    public ResponseEntity<Void> deleteAttach(@PathVariable("id") Long attachId) {
        attachInterfaces.deleteAttach(attachId);
    ...
    public ResponseEntity<List<AttachResponse>> uploadDirect(
        ...
        List<AttachResponse> result = attachInterfaces.uploadDirect(files);
